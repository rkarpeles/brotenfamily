...
//get featured img
$feat_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'blog-feature');
?>  
...
<article class="loop-entry clearfix">
	...
	<div class="loop-entry-meta">
        <span class="awesome-icon-calendar"></span><?php _e('On','surplus'); ?> <?php the_time('M'); ?> <?php the_time('j'); ?>, <?php the_time('Y'); ?>
